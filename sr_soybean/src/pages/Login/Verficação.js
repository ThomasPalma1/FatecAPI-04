      ...
      <>
        <View style={styles.container}>
          <View>
            ...
            <Text style={cssTalhao.subtitle}>Digite seu código de verificação.</Text>
          </View>
          <View style={styles.login}>
            <Text style={cssTalhao.talhao_inputText}>Código de verificação</Text>
            <TextInput style={cssTalhao.talhao_input} placeholder='Ex. ABC123'/>
          </View>
          <View>
            <Pressable style={styles.button} onPress={onPress}>
              <Text style={styles.text}>Confirmar código</Text>
            </Pressable>
            <Pressable style={styles.button} onPress={onPress}>
